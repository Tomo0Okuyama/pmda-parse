...
**PMDA（医薬品医療機器総合機構）** は、日本の独立行政法人で、医薬品、医療機器等の品質、有効性及び安全性について、治験相談から承認審査、市販後安全対策まで、一貫した規制業務を行っています。PMDAは承認された全ての医薬品について、添付文書情報をXML/SGML形式で公開しており、これらには以下の重要な医療情報が含まれています：

- **承認情報**: 効能・効果、用法・用量
- **安全性情報**: 副作用、禁忌、警告・注意事項
- **相互作用情報**: 他の薬剤や食品との併用に関する注意
- **成分情報**: 有効成分、添加物の詳細
- **製造元情報**: 製薬会社、承認番号等
...
### 1-3. 医療手技別用量テーブル対応
造影剤等の医療手技別用量テーブルを構造化して抽出：
```json
"dosage": [
  "通常、成人1回下記量を使用する。なお、年齢、体重、症状、目的により適宜増減する。",
  "脳血管撮影 → イオパミドール300注「F」:6～13mL",
  "血管心臓撮影（肺動脈撮影を含む） → イオパミドール370注「F」:20～50mL",
  "大動脈撮影 → イオパミドール300注「F」:30～50mL / イオパミドール370注「F」:30～50mL",
  "コンピューター断層撮影における造影 → イオパミドール150注「F」:200mL / イオパミドール300注「F」:100mL / イオパミドール370注「F」:100mL",
  "注意: 原液又は原液を生理食塩液で2～4倍希釈し用いる。",
  "注意: 50mL以上投与するときは、通常点滴静注とする。"
]
```
...
7. **医療手技別用量テーブル対応**
   - 造影剤等のSimpleTable構造の自動検出・解析
   - 医療手技名と対応薬剤・用量の構造化抽出
   - 複数薬剤濃度の同時対応（例：イオパミドール150/300/370）
   - テーブル関連の注意事項も適切に抽出
